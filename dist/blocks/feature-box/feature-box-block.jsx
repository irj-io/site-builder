    ...
    return (<Section {...getSectionProps(section)}>
			<div className={cn('container mx-auto flex min-h-64', direction)}>
				<div className="grow w-3/6">
					{media && typeof media === 'object' ? (<Media media={media} className="w-full h-full" imageClassName="size-full object-cover object-center w-full h-full" height={400} width={600}/>) : null}
				</div>
				<div className="grow w-3/6 p-8 sm:p-20 md:p-32">
					{overline ? <div className="text-sm mb-2">{overline}</div> : null}
					<div className="text-4xl font-semibold">{title}</div>
					{content ? (<div className="my-6">
...
//# sourceMappingURL=feature-box-block.jsx.map