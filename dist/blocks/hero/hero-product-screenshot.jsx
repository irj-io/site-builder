    ...
    return (<div className="flex flex-col">
			<div className="container mx-auto mt-16 mb-16 z-10 relative px-16">
				<div className="text-center">
					{title ? (<div className="mb-6 max-w-none mx-auto">
							<h1 className="text-5xl font-bold">{parseComponents(title)}</h1>
						</div>) : null}
					{subtitle ? (<div className="mb-2 max-w-none mx-auto">
				...
				{media && typeof media === 'object' ? (<div className="flex items-center justify-center mt-16">
						<Media className="rounded-lg shadow-2xl" media={media} quality={90} sizes={'100vw'} width={40} height={40} style={{
                height: 400,
                width: 'auto',
            }}/>
					</div>) : null}
...
//# sourceMappingURL=hero-product-screenshot.jsx.map