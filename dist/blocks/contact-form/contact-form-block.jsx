			...
			<div className="container mx-auto max-w-4xl flex flex-col gap-8">
				...
				<div className="flex gap-8">
					<div className="grow">
						<Field>
							...
							<Input className={cn('border mt-3 block w-full rounded-lg py-1.5 px-3 text-sm/6', 'data-[focus]:outline-2 data-[focus]:-outline-offset-2')}/>
						</Field>
					</div>
					<div className="grow">
						<Field>
				...
				<div className="">
					<Field>
						...
						<Textarea className={cn('border mt-3 block w-full rounded-lg py-1.5 px-3 text-sm/6', 'data-[focus]:outline-2 data-[focus]:-outline-offset-2')} rows={3}/>
					</Field>
				</div>
			</div>
		</Section>);
}
//# sourceMappingURL=contact-form-block.jsx.map