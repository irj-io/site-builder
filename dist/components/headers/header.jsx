...
export function Header(props) {
    ...
    return (<header className={cn('container mx-auto grid grid-cols-[auto_1fr_auto] items-center h-20 px-6 py-4 z-10 gap-4 text-foreground', { dark: theme === 'dark' })}>
