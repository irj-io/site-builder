...
const BreadcrumbSeparator = (_a) => {
    ...
    return (<li role="presentation" aria-hidden="true" className={cn('[&>svg]:w-3.5 [&>svg]:h-3.5', 'icon-symbols text-xl', className)} {...props}>
		{children !== null && children !== void 0 ? children : 'chevron_right'}
	</li>);
};
